...
ENV DB_SECRET_NAME=$DB_SECRET_NAME_HOM
...
RUN if [ "$ENVIRONMENT" = "https://prod.projeto-aws.com.br" ]; then \
    ...
    echo "$DB_HOST_HOM=db-hom-meddiflux.cluster-c9qkwqag6uxj.us-east-1.rds.amazonaws.com" >> .env; \
    echo "$DB_SECRET_NAME_HOM=rds!cluster-42d51256-37a1-433c-b7b8-868f6e67c357" >> .env; \
